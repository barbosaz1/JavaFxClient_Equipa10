...
public class EventosController implements Initializable {
    ...
    @FXML
    private TableView<EventoDTO> tabelaEventos;
    @FXML
    private TableColumn<EventoDTO, String> colTitulo, colData, colLocal, colVagas, colEstado;
    @FXML
    ...
    private void setupTable() {
        ...
        colVagas.setCellValueFactory(
                cell -> new SimpleStringProperty(String.valueOf(cell.getValue().getMaxParticipantes())));
    ...
    void handleInscricao() {
        ...
        task.setOnSucceeded(e -> {
            ...
            if (resultado.isListaEspera()) {
                ...
                showFeedback("Resultado: " + resultado.getResultado(), false);
            }
            resetButton();
        });
